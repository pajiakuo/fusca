...
public class RequestTask implements Runnable {
    ...
    private final MessagePack request;
    private boolean stopRun = false;

    public RequestTask(final Runnable runnable, final Channel channel, final MessagePack request) {
    ...
    public void returnResponse(int code, String remark) {
        ...
        RemotingHelper.writeChannelResponse(this.channel,response);
    }
}
